class Zeichne:
    ...
    def ZeichneFigur(self,x,y,spieler):
        ...
        id = self.uiParameter[0].create_oval((x*(self.uiParameter[1]/7))+self.uiParameter[3], untenLinksY,(x*(self.uiParameter[1]/7))+ (self.uiParameter[1]/7) + self.uiParameter[3],untenLinksY - (self.uiParameter[2]/6), fill = self.spielerFarben[spieler])
        self.zeichenObjekte.append(id)